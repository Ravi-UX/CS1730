...
/* Call-by-reference: 'Faking' call by value - parameters are still
 *  	copied but will 'copy an address instead'
 *	(both copies of the address points to the same address).
 *
